...
function liveMarkup(){return `<div class="ai-result"><strong>✦ Kết nối cho bạn</strong><p id="ai-live-text" class="ai-text"></p><div id="ai-sections" class="hidden"><section class="reading-section"><h3>Bức tranh chung</h3><p data-ai-part="1"></p></section><section class="reading-section action"><h3>Bước nhỏ trong 72 giờ</h3><p data-ai-part="2"></p></section></div></div>`}
